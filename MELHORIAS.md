...
- [x] **Webtor Player Iframe Sandbox:** Substituição do uso direto do script do Webtor por uma arquitetura isolada em `Iframe` com injeção de HTML puro (`srcDoc`). Isso garantiu 100% de proteção contra "Runtime Errors" e encerrou vazamentos de memória (ghost nodes) durante a troca de vídeos.
